  ...
  commands: [
    ...
    },
    {
      ...
      options: [
        ...
        { name: 'treasury-id', type: 'string', required: true },
        { name: 'treasury-key', type: 'string', required: true },
        { name: 'decimals', type: 'number', required: true },
        { name: 'initial-supply', type: 'number', required: true },
        { name: 'supply-type', type: 'string', required: true },
        { name: 'admin-key', type: 'string', required: true },
      ],
